...
DEFAULT_PERSONALITY = "musique_100"
...
def load_test_cases(dataset_path: str, limit: int = 100) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        for i, item in enumerate(data):
            ...
            if "answer_aliases" in item: targets.extend(item["answer_aliases"])

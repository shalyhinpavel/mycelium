...
DEFAULT_PERSONALITY = "frames_100"
...
def load_test_cases(dataset_path: str, limit: int = 100) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        for i, item in enumerate(data):
            ...
            gold_titles = set()
            if "gold_titles" in item:
                # FRAMES sampled format
                for title in item.get("gold_titles", []):
    ...
    for idx, case in enumerate(cases):
        ...
        try:
            payload = {
                ...
                "limit": 10,
                "hops": 5, # Higher hops for FRAMES
                "entity_top_k": 8, # More entities for FRAMES
                "w_resonance": 0.8,
                "w_reranker": 3.0,
                "rerank": True,
                "include_global": True
